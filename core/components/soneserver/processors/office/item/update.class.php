...
class sOneServerOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('soneserver_item_err_ns');
        }
...
return 'sOneServerOfficeItemUpdateProcessor';
