...
class sOneServerSiteUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('soneserver_site_err_ns');
        }
...
return 'sOneServerSiteUpdateProcessor';
